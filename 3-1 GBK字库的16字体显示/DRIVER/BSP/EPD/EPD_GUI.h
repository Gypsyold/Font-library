...
// 字体大小枚举（支持扩展更多字体）
typedef enum {
    FONT_16X16 = 0,  // 16×16 字体
    FONT_24X24 = 1,  // 24×24 字体
    FONT_32X32 = 2   // 32×32 字体
} Font_Size;
...
void EPD_ShowChineseString_flash(u16 x, u16 y, u8 *str, Font_Size font_size, u16 color);//字库字模显示
